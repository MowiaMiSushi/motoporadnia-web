  ...
  const renderHeroEditor = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Podtytuł</label>
          <input
            type="text"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) => setContent({
              ...content,
              hero: { ...content.hero, backgroundImages: e.target.value.split('\n').filter(url => url.trim()) }
            })}
            rows={3}
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500"
          />
  ...
  const renderSocialMediaEditor = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        {content.socialMedia.socials.map((social, index) => (
          <div key={index} className="border p-4 rounded-md space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  const newSocials = [...content.socialMedia.socials];
                  newSocials[index] = { ...social, platform: e.target.value };
                  setContent({
                    ...content,
                    socialMedia: { ...content.socialMedia, socials: newSocials }
                  });
                }}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  const newSocials = [...content.socialMedia.socials];
                  newSocials[index] = { ...social, description: e.target.value };
                  setContent({
                    ...content,
                    socialMedia: { ...content.socialMedia, socials: newSocials }
                  });
